...
for (const parte of ['prateleira', 'indicadores', 'medidas', 'leitura', 'conta-gotas', 'prever', 'ver', 'tubos', 'caderno', 'roteiros', 'frascos', 'tabela-indicadores', 'acessibilidade', 'app', 'limites']) {
