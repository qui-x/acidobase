'use strict';
SIAB.state = { tubes: [], activeId: null, nextId: 1, nextGroup: 1, view: 'focus', showPH: true, indicatorOnly: false, started: false };
...
SIAB.newTube = (options = {}) => {
  ...
  const tube = { id, name: `Tubo ${id}`, solution: 'hcl', concentration: .01, initialVolume: 1,
    titrant: 'naoh', titrantConcentration: .01, dilution: 1, titrantDilution: 1,
    dropVolume: .05, indicator: 'btb', additions: [], group: null, ...options };
