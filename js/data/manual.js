  ...
  },
  {
    ...
    blocos: [
      { lista: [
        ...
        'Adicionar ao relatório: confirma os tubos marcados. O relatório inclui só esses recipientes, com preparo, leitura, gráfico e histórico de cada um. “Revisar seleção” permite alterar a lista; “Usar relatório padrão” volta ao resumo da bancada e ao detalhe do tubo em foco. As leituras são as atuais e a lista vale enquanto a bancada estiver aberta.',
